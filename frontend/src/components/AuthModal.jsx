...
export default function AuthModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="relative w-full max-w-sm bg-[hsl(220,16%,12%)] border border-[hsl(220,14%,24%)] rounded-2xl p-7 shadow-2xl animate-fade-down">
        <button 
          onClick={onClose}
        ...
        {/* Tabs */}
        <div className="flex border border-[hsl(220,14%,24%)] rounded-lg overflow-hidden mb-5 mt-2">
